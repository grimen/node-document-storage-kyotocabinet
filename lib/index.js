...
KyotoCabinet.id = 'kyotocabinet';
KyotoCabinet.protocol = 'file';

KyotoCabinet.defaults = KyotoCabinet.defaults || {};
KyotoCabinet.defaults.url = Storage.env('KYOTOCABINET_URL') || 'file:///tmp/{db}-{env}'.assign({
  db: 'default',
  env: process.env.NODE_ENV || 'development'
});
KyotoCabinet.defaults.options = {
  server: {
    mode: 0777,
