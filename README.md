# NODE-DOCUMENT-STORAGE-KYOTOCABINET [![Build Status](https://secure.travis-ci.org/grimen/node-document-storage-kyotocabinet.png)](http://travis-ci.org/grimen/node-document-storage-kyotocabinet)
